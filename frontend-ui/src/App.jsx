  ...
  return (
    <div className="flex flex-col items-center p-4 gap-4 w-full max-w-sm mx-auto touch-none">
      ...
      <>
        ...
        {/* GitHub Repo Link */}
        <a
          href="https://github.com/PkuCuipy/handwriting-recognizer-torch-to-tfjs"
          target="_blank"
          rel="noopener noreferrer"
          class="text-blue-600 pt-4 flex items-center gap-2 font-medium py-2 px-4 rounded-md transition-colors duration-200"
        >
